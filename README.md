...
# DIV_INF
This is the old JHPWMDriver modified to remove ambiguous data types like "int" and inappropriate use of int where it should be uint8_t
Also adding some of the other commands necessary for using external clock.
